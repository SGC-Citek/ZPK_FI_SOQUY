...
@EndUserText.label: 'Ưu Tiên 1 Tên Người Nhập Nộp'
...
define view entity ZFI_I_GETNAME_NNOP_UUTIEN1
  as select distinct from I_OperationalAcctgDocItem as OADI
    ...
    left outer join       I_Supplier                as Sup on  Sup.Supplier              = OADI.AlternativePayeePayer
                                                           and OADI.FinancialAccountType = 'K'
    left outer join       I_Customer                as Cus on  Cus.Customer              = OADI.AlternativePayeePayer
...
//  key OADI.AccountingDocumentItem,
  ...
  OADI.AlternativePayeePayer as account1,
